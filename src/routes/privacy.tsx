...
const TITLE = "Privacy Policy — OrderWeb";
const DESC =
...
export const Route = createFileRoute("/privacy")({
  loader: async ({ location }) => {
    ...
    const page = await getPublicPageFn({ data: { key: "privacy", preview } });
    return page as { content: LegalPageContent; seo: PageSeo; preview: boolean };
  },
  head: ({ loaderData }) =>
    withJsonLd(
      pageHeadFromSeo(loaderData?.seo, { title: TITLE, description: DESC, path: "/privacy" }),
      pageBreadcrumbJsonLd("privacy"),
    ),
